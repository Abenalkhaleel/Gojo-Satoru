...
break
	    ...
	    case 'play': case 'فيديو': case 'ytplay': {
                if (!text) return reply(`Example : ${prefix + command} ابـن الخليـل ￦`)
                let yts = require("yt-search")
                let search = await yts(text)
...
┌─❖ مـرحبـاً 🤗 」
└┬❖ 「 ${pushname} 」
││✑「مـعـك بـوت ابـن الخليـل 👋🏻」￦
││✑「مـن اليـمـن🤗」￦
│└───────────────┈ ⳹
 「 مـعـلـومـات عـن الـبـوت 」
│✙「 اسـم الـبـوت 」￦ : 「 ابـن الخليـل ✨🤞🏻 」￦
